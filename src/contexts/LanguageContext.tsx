...
const translations: Record<string, Record<Lang, string>> = {
  ...
  "hero.subtitle": { en: "The Home of Football Culture", es: "The Home of Football Culture" },
  ...
  "collections.clubTeams": { en: "Club Teams", es: "Clubes" },
  "collections.retro": { en: "Retro", es: "Retro" },
  "collections.nationalTeams": { en: "National Teams", es: "Selecciones" },
  "collections.shorts": { en: "Shorts", es: "Shorts" },
  "collections.longSleeve": { en: "Long Sleeve", es: "Manga Larga" },
  "collections.specialEditions": { en: "Special Editions", es: "Ediciones Especiales" },
  "nav.backHome": { en: "Back to Home", es: "Volver al Inicio" },
  "search.trending": { en: "Trending", es: "Tendencias" },
